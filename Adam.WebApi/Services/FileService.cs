...
namespace Adam.Services
{
    public class FileService : IFileService
    {
        ...
        public FileResponseDto DownloadFiles(string subDirectory)
        {
            ...
            using (var memoryStream = new MemoryStream())
            {
                ...
                fileResponseDto.fileType = "application/zip";
                fileResponseDto.archiveData = memoryStream.ToArray();
                fileResponseDto.archiveName = zipName;
